...
| `05-start-menu.png` | Open the app on Windows | UpcurvEd in the Start menu, or its desktop shortcut | ⬜ needed |

That is the only Windows screenshot still outstanding. The final "It should look like
this" shot of the running app comes from `../common/app-running.png`, shared with the
macOS walkthrough — the window is identical on both platforms.
